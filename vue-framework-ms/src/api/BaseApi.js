...
export  default  class  BaseApi {
   ...
   */
   constructor(modelname)
   {
     ...
     this._getApiUrl="/api/"+modelname+"/Get";
     this._createApiUrl="/api/"+modelname+"/Create";
     this._updateApiUrl="/api/"+modelname+"/Update";
     this._getallApiUrl="/api/"+modelname+"/GetAll";
     this._deleteApiUrl="/api/"+modelname+"/Delete";
   }
   ...
   */
    async  get(parms){
       return await Http.POST(this._getApiUrl,parms);
    }
